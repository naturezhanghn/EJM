...
class HS_MSA(nn.Module):
    def __init__(
        ...
        if only_local_branch:
            ...
            # h,w = 128 * 2//self.heads,128 * 2//self.heads # Modify here
            seq_l2 = h*w//seq_l1
    ...
    def forward(self, x):
        ...
        if self.only_local_branch:
            ...
            print(sim1.shape, self.pos_emb1.shape)
            ...
            print(sim2.shape, self.pos_emb2.shape)
...
class DAUHST2(nn.Module):
    ...
    def forward(self, x, input_mask=None):
        ...
        # print(y.shape)
        # if input_mask == None:
        #     input_mask = [torch.zeros((b,28,256,310)).cuda(), torch.zeros((b,28,256,310)).cuda()] # torch.zeros((1,28,256,310)).cuda()
...
if __name__ == '__main__':
    ...
    net = DAUHST2(num_iterations=9).cuda()
    inp_shape = (1, 128, 128)
