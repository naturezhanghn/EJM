...
class SharpFormer(nn.Module):
    ...
    def __init__(self, in_chn=3, wf=64, depth=5, relu_slope=0.2, hin_position_left=0, hin_position_right=4):
        ...
        image_size = 8
        self.down_path_1.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
        self.down_path_1.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
        self.down_path_1.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
        self.down_path_2.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
        self.down_path_2.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
        self.down_path_2.append(Transformer(img_size=image_size, patch_size=1, embed_dims=prev_channels))
...
if __name__ == '__main__':
    ...
    net = SharpFormer(in_chn=img_channel,wf=width,hin_position_left=3,hin_position_right=4)
