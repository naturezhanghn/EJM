...
if __name__ == '__main__':
    ...
    net = fftformer(inp_channels=img_channel,out_channels=img_channel,dim=48,num_blocks=[6,6,12],num_refinement_blocks=4,ffn_expansion_factor=3,bias=False)
    ...
    # inp = torch.rand(1, 1, 480, 640).cuda()
    # net.cuda()
    # net.eval()
