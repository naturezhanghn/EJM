...
if __name__ == '__main__':
    ...
    net = NAFFFTNet(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
    ...
    #flow = torch.rand(1, 2, 128, 128).cuda()
    net.cuda()
    net.eval()
