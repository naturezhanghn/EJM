...
class NAFCoAFFTNetv4(nn.Module):
...
class NAFCoAFFTNetv4Local(Local_Base, NAFCoAFFTNetv4):
    def __init__(self, *args, train_size=(1, 1, 128, 128), base_size=192, fast_imp=False, **kwargs):
        Local_Base.__init__(self)
        NAFCoAFFTNetv4.__init__(self, *args, **kwargs)
...
if __name__ == '__main__':
    ...
    net = NAFCoAFFTNetv4(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
