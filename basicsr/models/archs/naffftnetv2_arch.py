...
if __name__ == '__main__':
    ...
    net = NAFFFTNetv2(img_channel=img_channel, width=width, middle_blk_num=middle_blk_num,
                      enc_blk_nums=enc_blks, dec_blk_nums=dec_blks, window_size_e=[64, 32, 16, 8], window_size_e_fft=[64, -1, -1, -1])
