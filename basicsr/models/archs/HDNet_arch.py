...
class HDNet(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=1, conv=default_conv): # in_ch=28, out_ch=28
        ...
        # m_head = [conv(in_ch, 28, kernel_size), conv(28, n_feats, kernel_size)]
        ...
        # m_tail = [conv(n_feats, 28, kernel_size), conv(28, out_ch, kernel_size)]
