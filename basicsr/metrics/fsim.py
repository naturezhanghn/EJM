...
# gt = cv2.imread('data/0_1_0_0_TDI_data_450001_gt.png', cv2.IMREAD_UNCHANGED)
# pred = cv2.imread('data/0_1_0_0_TDI_data_450001.png', cv2.IMREAD_UNCHANGED)
# print(fsim(org_img=gt, pred_img=pred))

def calculate_fsim(pred, gt):
    return fsim(gt, pred)