...
if __name__ == "__main__":
    ...
    # path1 = "/cold_data/zhangzr/remote_data/Inria_Aerial/AerialImageDataset/test/images/"
    # path2 = "/cold_data/zhangzr/remote_data/Inria_Aerial/AerialImageDataset/train/images/"
    path3= "/ailab/user/zhangziran/TDIdata/dotav1-all/"
                ...
                for j in range(0, width, img_w):
                    ...
                    img_TDI, jit_information, jit_roll_information, jit_pitch_information, sample_interval, jit_information_noise ,\
                       eq_jit_roll, eq_jit_pitch,jit_roll_noise, jit_pitch_noise, eq_jit_roll_clear, eq_jit_pitch_clear \
                        = TDI_CCD(img_crop_gamma , stage = 128, H = 5*10**5, focal_length = 10, u_size = 5*10**(-6),
                                    f_roll  = [ 100, 200, 300, 400] , amp_roll  = [ 4, 1.5, 1.0, 0.5] ,
                                    f_pitch = [ 100, 200, 300, 400] , amp_pitch = [ 1, 0.5, 0.3, 0.2] ,
                                    sigma_gauss = 0.14, lambda_poisson = 0.14 * 1e-2, subdivision = 6, jit_error = 0.2)
