...
parser.add_argument('--dataset', default='RealData_Stripformer_warp_lijiang', type=str, help='Test Dataset') # ['GoPro', 'HIDE', 'RealBlur_J', 'RealBlur_R']
...
with torch.no_grad():
    for file_ in tqdm(files):
        ...
        # img_tdi = img_tdi.astype(np.float32) / 255. / 255.
